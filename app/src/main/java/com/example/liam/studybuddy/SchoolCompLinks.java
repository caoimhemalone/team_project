...
public class SchoolCompLinks extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BTN1 = (Button)findViewById(R.id.compBTN1);
        BTN1.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Uri uri = Uri.parse("http://courses.ncirl.ie/index.cfm/page/course/courseId/2276"); // missing 'http://' will cause crashed
        ...
        //Computing
        BTN2 = (Button)findViewById(R.id.compBTN2);
        BTN2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Uri uri = Uri.parse("http://courses.ncirl.ie/index.cfm/page/course/courseId/2349"); // missing 'http://' will cause crashed
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
            }
        });
        ...
        BTN3 = (Button)findViewById(R.id.compBTN3);
        ...
        BTN4 = (Button)findViewById(R.id.compBTN4);
        BTN4.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Uri uri = Uri.parse("http://courses.ncirl.ie/index.cfm/page/course/courseId/2337"); // missing 'http://' will cause crashed
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
            }
        });
